...
exports.login = exports.CreateUser = exports.generateLink = void 0;
// Import necessary modules and libraries
const node_cache_1 = __importDefault(require("node-cache")); // Import the NodeCache library for caching [1]
const userModel_1 = require("../model/userModel"); // Import the createUser and getUserByEmail functions from the user model [3]
const utils_1 = require("../utils"); // Import the Authentication and random utility functions [4]
const sendGrid_1 = require("../utils/sendGrid"); // Import the sendConfirmationEmail function from the sendGrid utility module [5]
...
const extractUser_1 = __importDefault(require("../utils/extractUser"));
...
const generateLink = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield (0, sendGrid_1.sendConfirmationEmail)(req.body.email, link);
...
const CreateUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { id } = req.params;
        console.log("id", id);
        const reqBody = (0, extractUser_1.default)(id, cache);
        if (!reqBody) {
...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield (0, userModel_1.getUserByEmail)(email).select("+authentication.salt +authentication.password +authentication.sessionToken");
        ...
        const expectedHash = (0, utils_1.Authentication)(user.authentication.salt, password);
        ...
        user.authentication.sessionToken = (0, utils_1.Authentication)(salt, user._id.toString());
