...
import { validateUrlBody } from '../middleware/validation/validateUrl';

const router = Router(); // create a new instance of Router to handle routes

router.post('/new',isAuthenticated, validateUrlBody, createNewUrl); // define a POST route for '/new' path and use createNewUrl function as the route handler
